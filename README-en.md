...
A framework allows you make custom factional relations
...
`> allow you set the relation's tendency to vanilla relations for vanilla and other mod's logic, like vassal tend to Ally`

`> allow you set the trade's buy and sell price multiplier according to your custom relation`
