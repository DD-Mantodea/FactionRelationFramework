...
namespace FactionRelationFramework.Patches.FactionPatches
{
    ...
    public class CustomFactionRelationKindManager
    {
        ...
        internal static Dictionary<CustomFactionRelationKind, int> CustomRelations = [];
        ...
        internal static List<CustomFactionRelationKind> GetAllCustomFactionRelationKinds() => [.. CustomRelations.Keys];
    }
}
